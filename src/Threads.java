...
class RefreshThread implements Runnable{ //Refresh paint panel
...
class AutoSaveConfThread implements Runnable{
...
class SwitchControlThread implements Runnable{ //switch button & animation monitor
...
class HideBuyButtonThread implements Runnable {
